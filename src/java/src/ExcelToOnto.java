...
public class ExcelToOnto {
	...
	public ExcelToOnto (String FileExcel)
	{
		...
		try {
			ExcelFileExtractor ExcelFile = new ExcelFileExtractor (FileExcelInit);
	...
	public void ExcelOntoConv( String onto, String FileName)
	{
		...
		//Onto.CreateNewExceClass("Document", "ModifiedBy", "Document", "Auteur");
		Onto.CreateNewExceClass("Title", "TitleOf", "Title", "Document");
		Onto.CreateNewExceClass("Description", "DescriptionOf", "Description", "Document");
		Onto.CreateNewExceClass("Subject", "Concern", "Subject", "Document");
		Onto.CreateNewExceClass("Category", "hasDocument", "Category", "Document");
		Onto.CreateNewExceClass("Manager", "ManageSubject", "Manager", "Subject");
		Onto.CreateNewExceClass("Company", "hasasetof", "Company", "Document");
		//Onto.CreateNewExceClass("Company", "hasasetof", "Company", "Template");
	...
	Testfile.ExcelOntoConv( "http://www.ontologie.fr/monOntologie#", args[0]+".owl");
	}
