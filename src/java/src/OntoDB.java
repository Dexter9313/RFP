...
public class OntoDB extends Onto {
    String url;
    String user;
    String passwd;
        ...
        try {
            ...
            while(tables.next()) {
                ...
                while(fKeys.next()) {
                    ...
                    ObjectProperty fkProp = ontologie.createObjectProperty(namespace + nameCurrentTable + "Fk" + nameForeignTable);
            ...
            while(tables.next()) {
                ...
                while(columns.next()) {
                    ...
                    if(!list_keys.contains(columnName)) {
                        ...
                        ObjectProperty colProp = ontologie.createObjectProperty(namespace + nameTable + "Col" + columnName);
